...
import scrapy
from chocolatescraper.itemloaders import BalaProductLoader
from chocolatescraper.items import BalaProduct 
...
class BalaSpider(scrapy.Spider):
   ...
   name       = 'balarotispider'
   refs       = read_pickle('C:/Users/ArthurRodrigues/Codes/Variables/pricing_variables/BalaMap.pkl')
